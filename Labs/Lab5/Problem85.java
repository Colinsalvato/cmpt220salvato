...
public class Problem85 {
	...
	public static void main(String[] args) {
		...
		double[][] addedMatrix = newMatrix(matrix1, matrix2);

		for (int i = 0; i < matrix1.length; i++){

			for (int k = 0; k < matrix1[i].length; k++){
				System.out.printf("%4.1f ", matrix1[i][k]);
				if (i == 1 && k == 2) System.out.printf("%2s ", " + ");
				else System.out.printf("%3s ", " ");
			}
			for (int k = 0; k < matrix2[i].length; k++){
				System.out.printf("%4.1f ", matrix2[i][k]);
				if (i == 1 && k == 2) System.out.printf("%2s ", " = ");
				else System.out.printf("%3s ", " ");
	...
	public static double[][] newMatrix(double[][] a, double[][] b) {
